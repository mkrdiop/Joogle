...
pdffile = "cour-d'appel_n°2101478_23_11_2023.pdf"
...
#input_text="Par conclusions notifiées par voie électronique le 12 juillet 2021, M. [V] [P] demande à la cour de :"
# Tokenize and generate summary
inputs = tokenizer(input_text, truncation=True, padding="max_length", max_length=512, return_tensors="pt")
summary_ids = model.generate(inputs["input_ids"], max_length=1500, length_penalty=2.0, num_beams=4, early_stopping=True)
